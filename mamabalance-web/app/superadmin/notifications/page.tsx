...
type NotificationItem = {
  id: string;
  type: "support_ticket" | "staff_access" | "content_update";
  title: string;
  message: string;
...
export default function SuperadminNotificationsPage() {
  ...
  async function handleDismissNotification(event: MouseEvent<HTMLButtonElement>, id: string) {
    ...
    <div className="regional-notifications-page">
      <div className="doctor-page-header">
        <div className="role-header">
          ...
          <p>Review support tickets, staff account activity, and educational content updates.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="notifications-empty-card">
          ...
          <p>Support tickets, staff access changes, and content updates will appear here.</p>
        </div>
      ) : (
              ...
              <div className="notification-meta">
                <span>
                  {item.type === "support_ticket"
                    ...
                    : item.type === "staff_access"
                    ? "Staff access activity"
                    : "Educational content"}
                </span>
                <span>Requester: {item.requesterName || "Unknown User"}</span>
                <span>Role: {item.requesterRole || "-"}</span>
                <span>Category: {item.issueCategory || (item.type === "content_update" ? "Content" : "Operations")}</span>
